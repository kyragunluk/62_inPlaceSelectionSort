     ...
     */
     public OrderedList_inArraySlots
         ...
         for(int index = 0 ; index < list_iAS.size() ; index++ ){
              Integer currentObject = list_iAS.get(index);
              Integer nextSmallest = list_iAS.get(champIndex(list_iAS, index));
              int emptyIndex = champIndex(list_iAS, index);
      ...
      */
      private int champIndex( ArrayList<Integer> challengers , int startIndex) {
         Integer smallest = challengers.get(startIndex);
